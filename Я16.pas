...
#        print("player 1 wins-->You can listen Helloween music")
#        player1_score = player1_score + 1  # This is how we increment a variable
#    elif player2_value > player1_value:
#        print("player 2 wins-->You can listen Animals as Leaders music")
#        player2_score = player2_score + 1
#    else:
#        print("It's a draw-->Listen both Helloween and Animals as Leaders")
